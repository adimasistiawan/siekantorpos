...
<head>
  ...
  <link rel="stylesheet" href="{{asset('dist/css/skins/skin-yellow-light.css')}}">
...
<div class="wrapper">
  ...
  <header class="main-header skin-yellow">
    ...
    <!-- Logo -->
    <a class="logo">
      <span class="logo-mini"><b><img src="{{asset('logo.png')}}" width="200px" height="100px" alt=""></b></span>
      <span class="logo-lg"><b><img src="{{asset('logo.png')}}" width="200px" height="100px" alt=""></b></span>
    </a>
    ...
    <section class="sidebar">
      ...
      <div class="user-panel">
        <div class="pull-left image">
          <img src="{{asset('user/'.Auth::user()->foto)}}" class="img-circle" alt="User Image">
        </div>
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2021 <a>Kantor Pos Denpasar</a>.</strong>
  </footer>
